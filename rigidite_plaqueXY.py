...
ax.set(xlabel="Position sur l'axe des X (mm)", ylabel="Position sur l'axe des Y (mm)", zlabel="Rigidité (N/m)", title='Espace de rigidité')
...
# fig = plt.figure(figsize=paysage)
# ax.ticklabel_format(axis='z', style='scientific', scilimits=(-1, 1))
# ax = fig.add_subplot(111, projection="3d")
# ax.scatter(X, Y, rigiZ, label="Direction Z", marker='o', alpha=1, c="g")
# ax.plot(X, Y, rigiZ,c="g")
